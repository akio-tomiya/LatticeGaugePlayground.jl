...
const translations = {
  en: {
    ...
    'observables.normalizedPlaquette': 'Field strength on the lattice',
    'observables.polyakov': 'Polyakov loop |L|',
    'observables.polyakovDetail': 'Confinement order parameter',
  ...
  ja: {
    ...
    'observables.normalizedPlaquette': '格子上の場の強さ',
    'observables.polyakov': 'Polyakovループ |L|',
    'observables.polyakovDetail': '閉じ込めの秩序変数',
  ...
  'zh-Hans': {
    ...
    'observables.normalizedPlaquette': '格点上的场强',
    'observables.polyakov': 'Polyakov环 |L|',
    'observables.polyakovDetail': '禁闭序参量',
