...
export interface InitOutput {
    ...
    readonly __wbg_replsession_free: (a: number, b: number) => void;
    ...
    readonly replsession_eval_typed: (a: number, b: number, c: number) => any;
    readonly replsession_last_compile_ms: (a: number) => number;
    readonly replsession_new: (a: bigint) => number;
    readonly replsession_reset: (a: number) => void;
